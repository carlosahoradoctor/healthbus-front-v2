...
export const MENUITEMS = [
    ...
    // },
    {
        ...
        Items: [
            {
                title: 'Standards', icon: Box, type: 'link', path: `${process.env.PUBLIC_URL}/standards`
            },
            {
                title: 'User profile', icon: Users, type: 'link', path: `${process.env.PUBLIC_URL}/user-profiles`
            },
            {
                title: 'Companies', icon: Home, type: 'link', path: `${process.env.PUBLIC_URL}/companies`
            },
            {
                title: 'Organizations', icon: ShoppingBag, type: 'link', path: `${process.env.PUBLIC_URL}/organizations`
            },
            {
                title: 'Resources Mapper', icon: FolderPlus, type: 'link', path: `${process.env.PUBLIC_URL}/resources-mapper`
            },
            {
                title: 'Resources', icon: Cloud, type: 'link', path: `${process.env.PUBLIC_URL}/resources`
            },
            {
                title: 'Nodes', icon: Database, type: 'link', path: `${process.env.PUBLIC_URL}/nodes`
            },
            {
                title: 'Nodes Resources', icon: Monitor, type: 'link', path: `${process.env.PUBLIC_URL}/nodes-resources`
            },
            {
                title: 'Patients', icon: UserCheck, type: 'link', path: `${process.env.PUBLIC_URL}/patients`
            },
        ]
    },
    // {
