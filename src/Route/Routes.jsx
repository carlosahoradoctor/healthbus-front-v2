...
//Menu AhoraDoctor
import Standards from '../Components/AhoraDoctor/Standards';
import UserProfiles from '../Components/AhoraDoctor/UserProfiles';
import Companies from '../Components/AhoraDoctor/Companies';
import Organizations from '../Components/AhoraDoctor/Organizations';
import ResourcesMapper from '../Components/AhoraDoctor/ResourcesMapper';
import Resources from '../Components/AhoraDoctor/Resources';
import Nodes from '../Components/AhoraDoctor/Nodes';
import NodesResources from '../Components/AhoraDoctor/NodesResources';
import Patients from '../Components/AhoraDoctor/Patients';
...
export const routes = [
        ...
        //AhoraDoctor
        { path: `${process.env.PUBLIC_URL}/standards` , Component: <Standards /> },
        { path: `${process.env.PUBLIC_URL}/user-profiles` , Component: <UserProfiles /> },
        { path: `${process.env.PUBLIC_URL}/companies` , Component: <Companies /> },
        { path: `${process.env.PUBLIC_URL}/organizations` , Component: <Organizations /> },
        { path: `${process.env.PUBLIC_URL}/resources-mapper` , Component: <ResourcesMapper /> },
        { path: `${process.env.PUBLIC_URL}/resources` , Component: <Resources /> },
        { path: `${process.env.PUBLIC_URL}/nodes` , Component: <Nodes /> },
        { path: `${process.env.PUBLIC_URL}/nodes-resources` , Component: <NodesResources /> },
        { path: `${process.env.PUBLIC_URL}/patients` , Component: <Patients /> },
