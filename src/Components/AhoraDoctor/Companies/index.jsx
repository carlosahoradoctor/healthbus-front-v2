...
import { tableDataCompanies } from '../../../Data/DummyTableData';
...
const Companies = () => {
  const [data, setData] = useState(tableDataCompanies);
...
//"Authorization": "Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImF1dGgiOiJST0xFX0FETUlOLFJPTEVfVVNFUiIsImV4cCI6MTY3NDA2MDk2MH0.MYiJfg7Pf2ClLxDGZleZ63l0H5ynzWKHH7pGqV-DCOuMROuhA5Eo4g_fEdGAG6byzfX8HKdY8t9kOSYnaQQGJA"
  ...
  return (
    <Fragment>
      <Breadcrumbs parent="Menu" title="Companies" mainTitle="Companies" />
      <Container fluid={true} className="datatables">
        <Row>
          ...
          <Card>
            ...
            <Card>
              <HeaderCard title="List of Companies" />
              <CardBody>
                <DataTable
                  data={companies}
