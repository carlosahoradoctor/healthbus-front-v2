...
describe('Company e2e test', () => {
  ...
  describe('new Company page', () => {
    ...
    it('should create an instance of Company', () => {
      cy.get(`[data-cy="code"]`)
        .type('b393543f-c24d-479c-b556-e643551b87cb')
        .invoke('val')
        .should('match', new RegExp('b393543f-c24d-479c-b556-e643551b87cb'));

      cy.get(`[data-cy="name"]`).type('SMTP Wooden').should('have.value', 'SMTP Wooden');
